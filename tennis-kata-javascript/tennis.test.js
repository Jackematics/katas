...
var TennisScoreCalculator = require('./tennis1');
...
describe('getScore1', function () {
  each(allScores).it("when the points are %s:%s the score is %s", function (p1, p2, expected) {
    expect(TennisScoreCalculator.calculateScore(p1, p2)).toEqual(expected);
  });
});
